...
| Command | Purpose |
| --- | --- |
| `paperflow doctor` | Validate configuration, sources, reference DOCX, the Word styles the manuscript requests, environment, external tools, Git, Quarto, Pandoc, and required Python packages. |
