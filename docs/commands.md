...
| `paperflow clean --yes --include-archive` | Also remove the archived DOCX history. This explicit extra flag prevents accidental loss of prior generated versions. |
